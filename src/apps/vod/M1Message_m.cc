//
// Generated file, do not edit! Created by nedtool 5.7 from apps/vod/M1Message.msg.
//
...
inet::L3Address& M1Message::getClientAddr()
{
...
M1MessageDescriptor::M1MessageDescriptor() : omnetpp::cClassDescriptor("M1Message", "omnetpp::cMessage")
{
...
const char *M1MessageDescriptor::getFieldStructName(int field) const
{
    ...
    switch (field) {
        case 0: return omnetpp::opp_typename(typeid(inet::L3Address));
        default: return nullptr;
    };
}
