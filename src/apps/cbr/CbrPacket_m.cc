//
// Generated file, do not edit! Created by nedtool 5.7 from apps/cbr/CbrPacket.msg.
//
...
CbrPacket::CbrPacket(const char *name, short kind) : ::omnetpp::cPacket(name,kind)
{
    this->nframes = 0;
    this->IDframe = 0;
    this->timestamp = 0;
...
CbrPacket::CbrPacket(const CbrPacket& other) : ::omnetpp::cPacket(other)
{
    copy(other);
}
...
::omnetpp::simtime_t CbrPacket::getTimestamp() const
{
    return this->timestamp;
}

void CbrPacket::setTimestamp(::omnetpp::simtime_t timestamp)
{
...
unsigned int CbrPacket::getSize() const
{
    return this->size;
}

void CbrPacket::setSize(unsigned int size)
{
    this->size = size;
}
...
CbrPacketDescriptor::CbrPacketDescriptor() : omnetpp::cClassDescriptor("inet::CbrPacket", "omnetpp::cPacket")
{
...
int CbrPacketDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='n' && strcmp(fieldName, "nframes")==0) return base+0;
    if (fieldName[0]=='I' && strcmp(fieldName, "IDframe")==0) return base+1;
...
int CbrPacketDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    CbrPacket *pp = (CbrPacket *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

const char *CbrPacketDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string CbrPacketDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    CbrPacket *pp = (CbrPacket *)object; (void)pp;
    switch (field) {
        case 0: return ulong2string(pp->getNframes());
        case 1: return ulong2string(pp->getIDframe());
...
bool CbrPacketDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    CbrPacket *pp = (CbrPacket *)object; (void)pp;
    switch (field) {
        case 0: pp->setNframes(string2ulong(value)); return true;
        case 1: pp->setIDframe(string2ulong(value)); return true;
...
void *CbrPacketDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
