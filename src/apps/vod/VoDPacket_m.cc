//
// Generated file, do not edit! Created by nedtool 5.7 from apps/vod/VoDPacket.msg.
//
...
VoDPacket::VoDPacket(const char *name, short kind) : ::omnetpp::cPacket(name,kind)
{
    this->frameSeqNum = 0;
    this->frameLength = 0;
    this->tid = 0;
...
VoDPacket::VoDPacket(const VoDPacket& other) : ::omnetpp::cPacket(other)
{
    copy(other);
}
...
VoDPacketDescriptor::VoDPacketDescriptor() : omnetpp::cClassDescriptor("VoDPacket", "omnetpp::cPacket")
{
...
int VoDPacketDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='f' && strcmp(fieldName, "frameSeqNum")==0) return base+0;
    if (fieldName[0]=='f' && strcmp(fieldName, "frameLength")==0) return base+1;
    if (fieldName[0]=='t' && strcmp(fieldName, "tid")==0) return base+2;
    if (fieldName[0]=='q' && strcmp(fieldName, "qid")==0) return base+3;
...
int VoDPacketDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    VoDPacket *pp = (VoDPacket *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

const char *VoDPacketDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string VoDPacketDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    VoDPacket *pp = (VoDPacket *)object; (void)pp;
    switch (field) {
        case 0: return long2string(pp->getFrameSeqNum());
        case 1: return long2string(pp->getFrameLength());
        case 2: return long2string(pp->getTid());
        case 3: return long2string(pp->getQid());
        default: return "";
    }
}

bool VoDPacketDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    VoDPacket *pp = (VoDPacket *)object; (void)pp;
    switch (field) {
        case 0: pp->setFrameSeqNum(string2long(value)); return true;
        case 1: pp->setFrameLength(string2long(value)); return true;
        case 2: pp->setTid(string2long(value)); return true;
        case 3: pp->setQid(string2long(value)); return true;
...
void *VoDPacketDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
