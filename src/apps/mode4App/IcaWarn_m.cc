//
// Generated file, do not edit! Created by nedtool 5.7 from apps/mode4App/IcaWarn.msg.
//
...
IcaWarnDescriptor::IcaWarnDescriptor() : omnetpp::cClassDescriptor("IcaWarn", "omnetpp::cPacket")
{
...
std::string IcaWarnDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    IcaWarn *pp = (IcaWarn *)object; (void)pp;
    switch (field) {
        case 0: return long2string(pp->getMsgCnt());
        case 1: return oppstring2string(pp->getTempId());
        case 2: return long2string(pp->getIntersectionId());
...
bool IcaWarnDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    IcaWarn *pp = (IcaWarn *)object; (void)pp;
    switch (field) {
        case 0: pp->setMsgCnt(string2long(value)); return true;
        case 1: pp->setTempId((value)); return true;
        case 2: pp->setIntersectionId(string2long(value)); return true;
