//
// Generated file, do not edit! Created by nedtool 5.7 from apps/voip/VoipPacket.msg.
//
...
VoipPacket::VoipPacket(const char *name, short kind) : ::omnetpp::cPacket(name,kind)
{
    this->IDtalk = 0;
    this->nframes = 0;
    this->IDframe = 0;
...
VoipPacket::VoipPacket(const VoipPacket& other) : ::omnetpp::cPacket(other)
{
    copy(other);
}
...
::omnetpp::simtime_t VoipPacket::getTimestamp() const
{
    return this->timestamp;
}

void VoipPacket::setTimestamp(::omnetpp::simtime_t timestamp)
{
...
VoipPacketDescriptor::VoipPacketDescriptor() : omnetpp::cClassDescriptor("VoipPacket", "omnetpp::cPacket")
{
...
int VoipPacketDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *VoipPacketDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string VoipPacketDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    switch (field) {
        ...
        case 4: return simtime2string(pp->getArrivalTime());
        case 5: return simtime2string(pp->getPlayoutTime());
        case 6: return ulong2string(pp->getSize());
        default: return "";
    }
}

bool VoipPacketDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    switch (field) {
        ...
        case 4: pp->setArrivalTime(string2simtime(value)); return true;
        case 5: pp->setPlayoutTime(string2simtime(value)); return true;
...
void *VoipPacketDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
