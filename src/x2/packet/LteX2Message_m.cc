//
// Generated file, do not edit! Created by nedtool 5.7 from x2/packet/LteX2Message.msg.
//
...
LteX2Message_Base::LteX2Message_Base(const char *name, short kind) : ::omnetpp::cPacket(name,kind)
{
    this->sourceId = 0;
    this->destinationId = 0;
}

LteX2Message_Base::LteX2Message_Base(const LteX2Message_Base& other) : ::omnetpp::cPacket(other)
{
    copy(other);
}
...
LteX2MessageDescriptor::LteX2MessageDescriptor() : omnetpp::cClassDescriptor("LteX2Message", "omnetpp::cPacket")
{
...
int LteX2MessageDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    LteX2Message_Base *pp = (LteX2Message_Base *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

const char *LteX2MessageDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string LteX2MessageDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    switch (field) {
        ...
        case 1: return ulong2string(pp->getDestinationId());
        default: return "";
    }
}

bool LteX2MessageDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    switch (field) {
        ...
        case 1: pp->setDestinationId(string2ulong(value)); return true;
...
void *LteX2MessageDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
X2InformationElement_Base::X2InformationElement_Base(const char *name, short kind) : ::omnetpp::cPacket(name,kind)
{
}

X2InformationElement_Base::X2InformationElement_Base(const X2InformationElement_Base& other) : ::omnetpp::cPacket(other)
{
    copy(other);
}
...
X2InformationElementDescriptor::X2InformationElementDescriptor() : omnetpp::cClassDescriptor("X2InformationElement", "omnetpp::cPacket")
{
    propertynames = nullptr;
}
...
int X2InformationElementDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    X2InformationElement_Base *pp = (X2InformationElement_Base *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

const char *X2InformationElementDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string X2InformationElementDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
bool X2InformationElementDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
void *X2InformationElementDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
